...
- **Python**: Domínio completo de scripts que transformam dados em insights, ou até criam realidades alternativas. 🧠
- **C e C++**: Programação no limite do hardware e do software, onde desempenho e controle são essenciais. 🏎️
- **Arduino**: Projetos físicos que se conectam com o digital, criando mundos de possibilidades. 💡
